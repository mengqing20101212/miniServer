...
public class ShopInfo1Config {
  ...
  public ShopInfo1Config(int id, int grade, int school, String name, int type, int showType, String shopPara, String commodityList, int openType, int RefreshBarType, int openPara1, int openPara2, int openType2, int openPara3, int topId, int background, int subStoreShow, int shopShow) {
    this.id = id;
    this.grade = grade;
    this.school = school;
    this.name = name;
