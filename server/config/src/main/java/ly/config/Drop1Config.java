...
public class Drop1Config {
  ...
  public Drop1Config(int id, int dropType, String des, String dropList, String itemPro, String itemRelativePro, String dropTimes, String dropCounts) {
    this.id = id;
