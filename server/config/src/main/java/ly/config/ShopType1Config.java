...
public class ShopType1Config {
  ...
  public ShopType1Config(int id, String name, int type, String subShopList, int openType, int openPara1, int openPara2, int isShow, int showSort) {
    this.id = id;
    this.name = name;
    this.type = type;
