...
public class ActivitypassawardConfig {
  ...
  public ActivitypassawardConfig(int id, int scheDuling, int level, int payLevel, int rechargeShopId, int score,
      int freeGift, int freeGiftShow, int payGift, int payGiftShow, int redirectionId) {
    this.id = id;
